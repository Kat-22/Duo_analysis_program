...
def plot_graph(L_list, Energy_list, Title, energy_freq, energy_values, params2, matsd): #here you plot all graphs unlike other code because python handles it better than command line
